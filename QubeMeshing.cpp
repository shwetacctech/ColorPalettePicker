    ...
    : QMainWindow(parent)
{
    ...
    connect(mpushButton_7, &QPushButton::clicked, this, &QubeMeshing::colorPicker);
...
void QubeMeshing::setupUi() {
    ...
    mpushButton_7 = new QPushButton(mCentralWidget);
    mpushButton_7->setObjectName("pushButton_7");
    mpushButton_7->setGeometry(QRect(510, 30, 75, 24));
    mpushButton_7->setText("COLOR-");
